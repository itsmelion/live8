<section class="wave-section">
    ...
    <ul class="tabs justify-content-center">
		<li data-id="0">
      <a class="wave-btn wave-thing">
				<img src="<?php echo $itemSVG[0];?>">
				<span class="caption"><?php echo $itemCaption[0];?></span>
			</a>
    </li>
		<li data-id="1"><a data-id="1" class="wave-btn wave-thing">
				<img src="<?php echo $itemSVG[1];?>">
				<span class="caption"><?php echo $itemCaption[1];?></span>
		</a></li>
		<li data-id="2">
    	<a data-id="2" class="wave-btn wave-thing">
					<img src="<?php echo $itemSVG[2];?>">
		...
		<ul class="row tab__content">
			...
			<li class="offset-md-3 col-md-6">
				<div class="content__wrapper text-center">
					<h1><?php echo $itemCaption[0];?></h1>
					<p><?php echo $itemText[0];?></p>
				</div>
			</li>
			<li class="offset-md-3 col-md-6">
				<div class="content__wrapper text-center">
					<h1><?php echo $itemCaption[1];?></h1>
					<p><?php echo $itemText[1];?></p>
				</div>
			</li>
			<li class="offset-md-3 col-md-6">
				<div class="content__wrapper text-center">
					<h1><?php echo $itemCaption[2];?></h1>
					<p><?php echo $itemText[2];?></p>
				</div>
			</li>
		</ul>
	</div>
